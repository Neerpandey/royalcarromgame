...
export const XoBoard: React.FC<XoBoardProps> = ({ mode, difficulty, gridSize = 3, onBack }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center p-4 sm:p-8 animate-in fade-in duration-500 overflow-hidden bg-[url('https://www.transparenttextures.com/patterns/wood-pattern.png')] bg-opacity-5">
      ...
      {/* Status Bar */}
      <div className="flex flex-col items-center justify-center mb-4 z-10 shrink-0 gap-2">
        {!winner && (
          <>
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#d4af37]/10 border border-[#d4af37]/30 text-[#ffdf73] shadow-[0_0_10px_rgba(212,175,55,0.15)] animate-in fade-in slide-in-from-top-2">
               <Target className="w-4 h-4" />
               <span className="text-xs sm:text-sm font-black uppercase tracking-widest">Connect {winLength} to Win</span>
            </div>
