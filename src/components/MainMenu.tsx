...
export const MainMenu: React.FC<MainMenuProps> = ({
  ...
  return (
    <div className="relative h-[100dvh] min-h-[100dvh] w-full flex flex-col items-center justify-between p-3 sm:p-5 bg-[#0a0a0f] text-[#f3e5ab] overflow-y-auto overflow-x-hidden wood-pattern">
      ...
      {/* Top Navbar */}
      <header className="w-full max-w-4xl flex items-center justify-between z-10 px-1 py-1 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-[#171923]/90 hover:bg-[#202434] border border-[#d4af37]/30 transition shadow-lg group active:scale-95 cursor-pointer"
        >
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#2a2e42] border border-[#d4af37] flex items-center justify-center text-base sm:text-lg">
            {userProfile.avatar}
          </div>
          <div className="text-left">
            <div className="text-[11px] sm:text-xs font-bold text-[#f3e5ab] group-hover:text-[#ffdf73] transition leading-tight">
              {userProfile.name}
            </div>
            <div className="text-[9px] sm:text-[10px] text-[#d4af37] flex items-center gap-1">
              <Crown className="w-2.5 h-2.5 text-[#ff4d6d]" /> {userProfile.queens} Queens Sunk
            </div>
          </div>
        </button>
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="p-2 rounded-xl bg-[#171923]/90 hover:bg-[#202434] text-[#d4af37] border border-[#d4af37]/30 transition shadow-md active:scale-95 cursor-pointer"
            title="Toggle Sound"
          >
