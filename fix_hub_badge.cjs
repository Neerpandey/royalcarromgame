...
const oldBadges = `<div className="absolute top-0 right-0 p-4 z-20 flex flex-col gap-2 items-end">
...
const newBadge = `<div className="absolute top-0 right-0 p-4 z-20">
...
code = code.replace(oldBadges, newBadge);
fs.writeFileSync('src/components/HomeHub.tsx', code);
console.log("HomeHub badge updated successfully.");
